...
export async function DELETE(request, { params }) {
  try {
    ...
    // If deleteData flag is set, delete all biometric data created by this device
    if (deleteData) {
      // Delete all biometric data for this patient that was generated by this device
      // Source is set to device_name when data is generated
