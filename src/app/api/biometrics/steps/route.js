...
export async function GET(req) {
  try {
    ...
    if (period === 'today') {
      ...
      const avgHourly = Math.round(totalSteps / hoursWithData);
      ...
      const avgMonthly = daysWithData > 0 ? Math.round(totalSteps / daysWithData) : 0;
      ...
      const avgDaily = daysWithData > 0 ? Math.round(totalSteps / daysWithData) : 0;
