            ...
            {providers.map((provider) => (
              ...
              >
                ...
                <button
                  ...
                  className="w-full p-6 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors flex items-center justify-between"
                >
                      ...
                      prescriptionsByProvider[provider.id].map((prescription) => (
                        ...
                        >
                          ...
                          <button
                            ...
                            className="w-full px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:bg-blue-400 disabled:cursor-not-allowed flex items-center justify-center gap-2 transition-colors text-sm font-medium"
                          >
                            {isExporting ? (
